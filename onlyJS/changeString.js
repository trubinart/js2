...
// let text = "One: 'Hi Mary.' Two: 'Oh, hi.' One: 'How are you do'ing? 'Yes. It's absolutely beautiful today.'"


// console.log(text.replace(/(?![a-z]'[a-z])(.)'|^'/g, '$1"'));
alert(text.replace(/(?![a-zA-Z]'[a-z])(.)'|^'/g, '$1"'));
